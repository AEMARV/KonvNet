...
class VGG_Konv(Experiment_):
	...
	def collect_opts(self):
		...
		for dataset in datasets:
			...
			for model in [self.KVGG_CIFAR10]:

				''' Alpha Regularzation'''
				model_opt, optim_opt = model(dataopt, weight_decay=0, init_coef=coef,
				                             val_iterations=1, lr=.1)
				experiment_name = model.__name__ + "|l2_coef=0"
	...
	def KVGG_CIFAR10(self,data_opts: DataOpts,
		...
		model_string += 'konvs|r:3,f:{},pad:same,stride:1,bias:1,{}'.format(ceil(scale*64),convparam) + d
		model_string += 'konvr|r:3,f:{},pad:same,stride:1,bias:1,{}'.format(ceil(scale*64),convparam) + d
		model_string += 'klavgpool|r:2,pad:valid,stride:2,bias:1,{}'.format(convparam) + d
		model_string += 'konvr|r:3,f:{},pad:same,stride:1,bias:1,{}'.format(ceil(scale*128),convparam) + d
		model_string += 'konvr|r:3,f:{},pad:same,stride:1,bias:1,{}'.format(ceil(scale*128),convparam) + d
		model_string += 'klavgpool|r:2,pad:valid,stride:2,bias:1,{}'.format(convparam) + d
		model_string += 'konvr|r:3,f:{},pad:same,stride:1,bias:1,{}'.format(ceil(scale*256),convparam) + d
		model_string += 'konvr|r:3,f:{},pad:same,stride:1,bias:1,{}'.format(ceil(scale*256),convparam) + d
		model_string += 'konvr|r:3,f:{},pad:same,stride:1,bias:1,{}'.format(ceil(scale*256),convparam) + d
		model_string += 'klavgpool|r:2,pad:valid,stride:2,bias:1,{}'.format(convparam) + d
		model_string += 'konvr|r:3,f:{},pad:same,stride:1,bias:1,{}'.format(ceil(scale*512),convparam) + d
		model_string += 'konvr|r:3,f:{},pad:same,stride:1,bias:1,{}'.format(ceil(scale*512),convparam) + d
		model_string += 'konvr|r:3,f:{},pad:same,stride:1,bias:1,{}'.format(ceil(scale*512),convparam) + d
		model_string += 'klavgpool|r:2,pad:valid,stride:2,bias:1,{}'.format(convparam) + d
		model_string += 'konvr|r:3,f:{},pad:same,stride:1,bias:1,{}'.format(ceil(scale*512),convparam) + d
		...
		model_string += 'konvr|r:3,f:{},pad:same,stride:1,bias:1,{}'.format(ceil(scale*512),convparam) + d
		model_string += 'klavgpool|r:2,pad:valid,stride:2,bias:1,{}'.format(convparam) + d
		model_string += 'konvr|r:1,f:{},pad:same,stride:1,bias:1,{}'.format(ceil(scale*512),convparam) + d
		model_string += 'konvr|r:1,f:' + str(data_opts.classnum) + ',pad:valid,stride:1,bias:1,{}'.format(convparam) + d
		...
		''' Net Options'''
		netdict = dict(exact=True, divgreg=None, reg_coef=None, reg_mode=None, alphaPrior=1,val_iters=val_iterations)
